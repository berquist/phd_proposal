...
\label{sec:orgde70f0a}

\subsection{Machine Learning}
\label{sec:org2282ab6}
...
\item \emph{Unsupervised learning}: Train a machine learning model using data where the correct output prediction is not given, and the goal of the model is to learn intrinsic properties of the inputs by recreating or reconstructing the input as output.
\end{itemize}

\subsection{Machine Learning in Chemistry}
\label{sec:org52c36fc}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in [\ref{fig:orgee5910c}]. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as [\ref{fig:orgee5910c}] can be built upon.
...
\label{sec:org9143faa}

\subsubsection{Introduction}
\label{sec:orgfff2d14}
...
\label{sec:orge545057}

\subsubsection{Introduction}
\label{sec:org63df043}
...
\label{sec:orgc7de80c}

\subsubsection{Introduction}
\label{sec:org5ba0ff4}

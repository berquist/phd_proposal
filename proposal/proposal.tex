...
\label{sec:org64c6f38}

\subsection{Machine Learning}
\label{sec:org6767409}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in \ref{fig:org82610e0}. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as \ref{fig:org82610e0} can be built upon.
...
\label{sec:orgced2414}

\subsubsection{Introduction}
\label{sec:org6e3788b}
...
\label{sec:org9e9bad7}

\subsubsection{Introduction}
\label{sec:org0cf2781}
...
\label{sec:orgdf0be66}

\subsubsection{Introduction}
\label{sec:org5795f07}

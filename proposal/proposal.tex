...
\label{sec:org075db87}

\subsection{Machine Learning}
\label{sec:orgb66a7d8}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in \ref{fig:org9111424}. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as \ref{fig:org9111424} can be built upon.
...
\label{sec:orga4c401e}

\subsubsection{Introduction}
\label{sec:orgfc7aa2a}
...
\label{sec:orgc37f052}

\subsubsection{Introduction}
\label{sec:org62686ac}
...
\label{sec:org73e28dc}

\subsubsection{Introduction}
\label{sec:org4281745}

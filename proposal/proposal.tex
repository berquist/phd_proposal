...
\label{sec:orgce58f75}

\subsection{Machine Learning}
\label{sec:org54b7c7e}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in [\ref{fig:orgf38d08a}]. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as [\ref{fig:orgf38d08a}] can be built upon.
...
\label{sec:org8e45a3a}

\subsubsection{Introduction}
\label{sec:org6d8cee1}
...
\label{sec:orgf9ac2c1}

\subsubsection{Introduction}
\label{sec:orgce45584}
...
\label{sec:org3d276aa}

\subsubsection{Introduction}
\label{sec:org2364f71}

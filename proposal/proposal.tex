...
\label{sec:org3dbda40}

\subsection{Machine Learning}
\label{sec:orgfeb09e5}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in \ref{fig:org43bc637}. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as \ref{fig:org43bc637} can be built upon.
...
\label{sec:org0fea075}

\subsubsection{Introduction}
\label{sec:org7660f74}
...
\subsubsection{Expected Outcomes}
\label{sec:orged1deee}

Once LRP is applied to the trained models, \fxnote{TODO stuff about analysis and visualization of LRP results. Thinking simple bar chart, with 1 bar per feature type, with error bars describing the distribution of LRP results across all training samples.}
...
\label{sec:orge0077d1}

\subsubsection{Introduction}
\label{sec:org777864d}
...
\label{sec:orga1520a2}

\subsubsection{Introduction}
\label{sec:orgbf405ce}

...
\begin{itemize}
\item \emph{Supervised learning}: Train a machine learning model using data where the correct output prediction is known and given for each input sample, and the goal of the model is to predict similar types of outputs for new inputs \fxnote{[REF]}.
\item \emph{Unsupervised learning}: Train a machine learning model using data where the correct output prediction is not given, and the goal of the model is to learn intrinsic properties of the inputs by recreating the input as output \fxnote{[REF]}.
\end{itemize}

\subsection{Neural Networks}
\label{sec:org42b0ebb}
...
\label{sec:org10a188b}

\subsubsection{Introduction}
\label{sec:org1a09e32}
...
\label{sec:org376ff85}

\subsubsection{Introduction}
\label{sec:org4c92d1b}
...
\label{sec:org94ca073}

\subsubsection{Introduction}
\label{sec:org31e45b2}

...
\label{sec:org57a9c11}

\subsection{Machine Learning}
\label{sec:org83cc878}
...
The closest use of input relevance in molecular predictions is monitoring the evolution of input features as network training progresses\cite{Kearnes2016}, shown in \ref{fig:org43069e6}. However, there is no definition for what the evolution of input features is, such as the metric for evolution, or what the units are. One aim of this proposal is to form a quantitative basis connecting molecular features to model predictions that figures such as \ref{fig:org43069e6} can be built upon.
...
\label{sec:orgd9946ea}

\subsubsection{Introduction}
\label{sec:org13201de}
...
\label{sec:orgbe2409e}

\subsubsection{Introduction}
\label{sec:org4d32041}
...
\label{sec:org5e359d9}

\subsubsection{Introduction}
\label{sec:orgeef5335}

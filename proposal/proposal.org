...
- To test this hypothesis, I will develop the necessary ML pipeline for adding relevance propagation and analysis steps to the already-published ML models. This will involve connecting existing relevance propagation tools \cite{JMLR:v17:15-618,github:lrp} to the end of the pipeline from aim #1.

*** Research Design

From their GitHub page\cite{github:lrp},
...
The existence of an open-source implementation of the relevance propagation algorithm

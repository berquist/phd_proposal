...
\begin{frame}{Objective}
  ...
  \item If they aren't, consider other NN architectures (DTNN, ANAKIN-ME, ...) that have different input \textit{representations} or \textit{featurizations} for molecules
  \end{itemize}
\end{frame}
...
\begin{frame}{Specific Aims}
  ...
  \item[2.] Characterize the parameters learned by existing machine learning models from the literature using relevance propagation.
...
\begin{frame}{An (imperfect) conenction between neural networks and quantum chemistry}
  \begin{itemize}

...
\begin{frame}{Machine learning has a perception problem}
  Machine learning is a ``fad'' and produces all these great results, but we joke semi-seriously that we don't know what's going on under the hood, even though it will solve all our problems (something about robot overlords).
  \begin{center}
...
\begin{frame}{Rationale}
  \begin{itemize}
  \item Building ML models that can do real, useful chemistry in a general manner is impossible without proving meaningfulness of simpler models

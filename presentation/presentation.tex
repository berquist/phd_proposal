...
\begin{frame}{Overview}
  ...
  \item \underline{Gap}: We don't know if current approaches (ML architectures) will be transferable to more complex molecules or properties.
  \item \underline{Challenge}: If a ML model is not right for the right reasons, there cannot be an expectation that it is transferable or extendable in any way.
  \end{itemize}
